define(["require", "exports", "./Tool", "../EventManager", "../HistoryStep"], function (require, exports, Tool_1, EventManager_1, HistoryStep_1) {
     ...
     */
    class RectangleSelectionTool extends Tool_1.Tool {
        /**
         ...
         * @author Mathieu Fehr
         */
        applySelection(firstPoint, secondPoint) {
            // The current image
         ...
         * @author Mathieu Fehr
         */
        previewSelection(firstPoint, secondPoint) {
            // The current image
            let width = this.workspace.selectedArea.width;
            let height = this.workspace.selectedArea.height;
            // Get the rectangle corners
    ...
    exports.RectangleSelectionTool = RectangleSelectionTool;
});
