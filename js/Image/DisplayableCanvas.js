define(["require", "exports", "./Canvas", "../utils/Point"], function (require, exports, Canvas_1, Point_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Represent a HTML5 canvas that is drawn in the web page.
     */
    class DisplayableCanvas extends Canvas_1.Canvas {
        /**
         ...
         * @author Mathieu Fehr
         */
        constructor(width, height, id, eventManager) {
        ...
        getMouseEventCoordinates(event) {
            ...
            let coordinates = new Point_1.Point(mouseX, mouseY);
    ...
    exports.DisplayableCanvas = DisplayableCanvas;
});
