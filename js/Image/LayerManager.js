define(["require", "exports", "./Layer", "../EventManager", "../HistoryStep"], function (require, exports, Layer_1, EventManager_1, HistoryStep_1) {
    "use strict";
    ...
    class LayerManager {
         ...
         */
        getLayerIndexFromId(id) {
            return this.layers.findIndex((layer) => { return layer.id === id; });
        }
        /**
        ...
        deleteLayer(id) {
            ...
            if (layerIndex >= 0) {
                ...
                EventManager_1.EventManager.spawnEvent("rubens_deleteLayer");
            }
        }
        /**
        ...
        createLayer(name) {
            ...
            let newLayer = new Layer_1.Layer(this.width, this.height, this.eventManager, name, this.lastId);
            ...
            EventManager_1.EventManager.spawnEvent("rubens_addLayer");
        }
        /**
         ...
         * @author Mathieu Fehr, Camille Gobert
         */
        moveLayer(id, nextPosition, saveInHistory = true) {
            if (nextPosition < 0) {
            ...
            EventManager_1.EventManager.spawnEvent("rubens_moveLayer");
            if (saveInHistory) {
                EventManager_1.EventManager.spawnEvent("rubens_historySaveStep", new HistoryStep_1.GenericHistoryStep("Moving a layer", () => { this.moveLayer(id, nextPosition, false); }, () => { this.moveLayer(id, layerIndex, false); }));
            }
        }
        /**
        ...
        selectLayer(id) {
            ...
            if (index !== -1) {
                ...
                EventManager_1.EventManager.spawnEvent("rubens_selectLayer");
            }
        }
        /**
         ...
         * @author Camille Gobert
         */
        mergeLayersWithIndices(topLayerIndex, bottomLayerIndex) {
            ...
            EventManager_1.EventManager.spawnEvent("rubens_mergeLayers");
        }
        /**
         ...
         * @author Camille Gobert
         */
        renameLayer(id, name, saveInHistory = true) {
            let index = this.getLayerIndexFromId(id);
            let oldName = new String(this.layers[index].name).toString();
            console.log(oldName + " -> " + name);
            if (index !== -1) {
                this.layers[index].name = name;
                EventManager_1.EventManager.spawnEvent("rubens_renameLayer");
                if (saveInHistory) {
                    EventManager_1.EventManager.spawnEvent("rubens_historySaveStep", new HistoryStep_1.GenericHistoryStep("Rename layer", () => { this.renameLayer(id, name, false); }, () => { this.renameLayer(id, oldName, false); }));
                }
            }
        }
        /**
         ...
         * @author Camille Gobert
         */
        changeLayerBlendMode(id, mode) {
            let index = this.getLayerIndexFromId(id);
            if (index !== -1) {
                this.layers[index].blendMode = mode;
                EventManager_1.EventManager.spawnEvent("rubens_changeLayerBlendMode");
            }
        }
        /**
         ...
         * @author Camille Gobert
         */
        changeSelectedLayerBlendMode(mode) {
         ...
         * @author Camille Gobert
         */
        switchLayerVisibility(id) {
            let index = this.getLayerIndexFromId(id);
            this.layers[index].hidden = !this.layers[index].hidden;
            EventManager_1.EventManager.spawnEvent("rubens_changeLayerVisibility");
        }
        /**
