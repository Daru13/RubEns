define(["require", "exports", "jquery"], function (require, exports, $) {
    ...
    class ImageLoader {
        ...
        static load(onImageReady) {
            ...
            inputNode.on("change", (_) => this.onInputNodeChange(inputNode[0], onImageReady));
            inputNode.hide();
         ...
         * @author Mathieu Fehr, Camille Gobert
         */
        static onInputNodeChange(inputNode, onImageReady) {
        ...
        static readLoadedFile(file, onImageReady) {
